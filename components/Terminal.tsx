...
// import { ChangeEvent, useRef } from "preact";
...
//         items.push(<span class={"block whitespace-pre-wrap" + mod} key={i}>{line}</span>);
//         i++;
//     }
...
//     return (
//         <div class="terminal-scroll overflow-y-auto overflow-x-hidden rounded-xl border-solid leading-tight border-gray-400
...
//             <span>
//                 &gt;&nbsp;
//                 <input class="bg-black w-[90%] border-none m-0 p-0 outline-none" ref={inputRef} type="text"
